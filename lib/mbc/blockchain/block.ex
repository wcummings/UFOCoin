...
defmodule MBC.Blockchain.Block do
  ...
  def decode(<<prev_block_hash :: size(32), timestamp :: size(64), difficulty :: size(32), height :: size(32), nonce :: size(32), tx_count :: size(32), rest :: binary>>) do
    %MBC.Blockchain.Block{prev_block_hash: <<prev_block_hash :: size(32)>>, timestamp: timestamp, difficulty: difficulty, height: height, nonce: <<nonce :: size(32)>>} # FIXME: TXs
  end
  ...
  def check_nonce(block = <<_ :: size(32), _ :: size(32), difficulty :: size(32), _ :: binary>>) do
  ...
  def update_nonce(encoded_block, new_nonce) do
    <<prev_block_hash :: size(32), timestamp :: size(32), difficulty :: size(32), height :: size(32), _nonce :: size(32), rest :: binary>> = encoded_block
    <<prev_block_hash :: size(32), timestamp :: size(32), difficulty :: size(32), height :: size(32), new_nonce :: binary, rest :: binary>>
  end
